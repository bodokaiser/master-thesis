...
\begin{document}
	\begin{tikzpicture}[
		node distance=4em,
		arrow/.style={-latex},
		block/.style={draw, very thick, fill=white, minimum height=12ex, minimum width=8em, align=center},
	]
		...
		\draw[arrow] ([yshift=4ex]dsp.east) -- ([yshift=4ex]dac.west) node[midway, above]{$x^\prime[m]$};
		\draw[arrow] ([yshift=-4ex]dsp.east) -- ([yshift=-4ex]dac.west) node[midway, above]{$p^\prime[m]$};
		...
		\draw[arrow] ([yshift=4ex]asp.west) -- ([yshift=4ex]mod.east) node[midway, above]{$x(t)$};
		\draw[arrow] ([yshift=-4ex]asp.west) -- ([yshift=-4ex]mod.east) node[midway, above]{$p(t)$};
