...
\begin{document}
	\begin{tikzpicture}[
		...
		\node (dsp) [block, right=of in] {\textsf{DSP}};
		\node (dac) [block, right=of dsp] {\textsf{DAC}};
		\node (asp) [block, right=of dac] {\textsf{ASP}};
		\node (mod) [block, right=of asp] {\textsf{MOD}};
		\node (osp) [block, right=of mod] {\textsf{OSP}};
