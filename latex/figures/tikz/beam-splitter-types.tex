...
\begin{document}
    \begin{tikzpicture}
        \begin{scope}
            ...
            \draw[very thick] (prism1 b) ++(0.1, 0.1) coordinate (prism2 a);
            \draw[very thick] (prism1 c) ++(0.1, 0.1) coordinate (prism2 c);
            ...
            \draw[very thick, rounded corners=1] (prism1 a) -- (prism1 b) -- (prism2 a) -- (prism2 b) -- (prism2 c) -- (prism1 c) -- cycle;
        \end{scope}

        \node at (3.2, 2) {b)};
        \begin{scope}[xshift=3.5cm, yshift=0.3cm, rotate=-45]
            \draw[very thick, rounded corners=1] (0, 0) rectangle (0.3, 2.25);
