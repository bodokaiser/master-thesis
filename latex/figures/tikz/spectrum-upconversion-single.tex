...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[very thick] (-0.5,0) -- ++(0,0.5) -- ++(0.5,-0.25) -- ++(0.5,0.25) -- ++(0,-0.5);
		\draw[very thick] (3,1) -- ++(0,-1.15) node[below] {$+\omega_c$};
		\draw[very thick] (-3,1) -- ++(0,-1.15) node[below] {$-\omega_c$};
		\draw[very thick, dashed] (-3.5,0) -- ++(0,0.5) -- ++(0.5,-0.25) -- ++(0.5,0.25) -- ++(0,-0.5);
		\draw[very thick, dashed] (2.5,0) -- ++(0,0.5) -- ++(0.5,-0.25) -- ++(0.5,0.25) -- ++(0,-0.5);
