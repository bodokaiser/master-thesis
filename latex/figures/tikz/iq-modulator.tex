...
\begin{document}
	\begin{tikzpicture}
        ...
        \draw (2.5,2) node[oscillator, label={left:$\cos(\omega_0t)$}](osc){} to[short] (mixer.west |- osc) node[inputarrow]{} node[twoportsplitshape, anchor=west, circuitikz/t1=$\SI{0}{\degree}$, circuitikz/t2=$\SI{90}{\degree}$](splitter){};
        ...
        \draw (splitter) ++(5,0) node[adder](adder){};
        \draw (mixer.east) to[lowpass, >, l=LP] (mixer-|adder) to[short] (adder.south) node[inputarrow, rotate=90]{};
        \draw (mixer2.east) to[lowpass, >, l=LP] (mixer2-|adder) to[short] (adder.north) node[inputarrow, rotate=-90]{};
