...
\begin{document}
	\begin{tikzpicture}[
		...
		\draw (ups1.east) -- (psh1.west) node[above, midway, sloped]{$\Re{\alpha^\prime[n]}$} node[inputarrow]{};
		\draw (psh1.east) -- (dac1.west) node[above, midway, sloped]{$x^\prime[n]$} node[inputarrow]{};
		...
		\draw (ups2.east) -- (psh2.west) node[above, midway, sloped]{$\Im{\alpha^\prime[n]}$} node[inputarrow]{};
		\draw (psh2.east) -- (dac2.west) node[above, midway, sloped]{$p^\prime[n]$} node[inputarrow]{};
		...
		\node at (dac1.north|-cri) [rotate=90] {Sample-and-hold};
