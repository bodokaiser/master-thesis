...
\begin{document}
	...
	\begin{refsection}
		\textit{The following chapter presents the context, problem and motivation of the present thesis. Furthermore, we introduce the reader to the structure of the thesis as well as the adapted conventions and notation.}
	...
	\begin{refsection}
		\input{chapters/quantum-key-distribution/discrete}
		\input{chapters/quantum-key-distribution/continuous}
	...
	\begin{refsection}
		...
		\input{chapters/classical-post-processing/overview}
		\input{chapters/classical-post-processing/reconciliation}
		\input{chapters/classical-post-processing/error-correction}
		\input{chapters/classical-post-processing/privacy-amplification}
