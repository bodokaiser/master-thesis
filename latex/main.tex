...
\begin{document}
	...
	\begin{refsection}
		\input{chapters/coherent-state-communication-system/introduction}
		\input{chapters/coherent-state-communication-system/transmitter}
		\input{chapters/coherent-state-communication-system/channel}
		\input{chapters/coherent-state-communication-system/receiver}
