...
In qubit-based protocols, like, e.g., BB84~\cite{Bennett1984}, the logical quantum system is a qubit.
...
The most popular protocol is  because of its simplicity and well-developed security proof~\cite{Shor2000}.
...
The post-processing distills a secret key bit string from the partially secret and correlated bit string Alice and Bob obtained from the transmission, see \Cref{fig:post_processing} for details.
...
\begin{figure}[htb]
	\centering
	\includestandalone{figures/pstricks/polarization-encoding-bb84-single}
	\caption{Foo.}
\end{figure}
\begin{figure}[htb]
	\centering
	\includestandalone{figures/pstricks/polarization-encoding-bb84-dual}
	\caption{Foo.}
\end{figure}
