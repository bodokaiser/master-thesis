...
\begin{figure}[htb]
	\centering
	\includestandalone{figures/pstricks/polarization-encoding-bb84-active}
...
The basic setup is illustrated in \Cref{fig:time_phase_encoding_bb84} and comprises a single-photon source and a first \gls{mzi} on Alice's side as well as a second \gls{mzi} and two single-photon detectors on Bob's side.
\begin{figure}[htb]
	\centering
