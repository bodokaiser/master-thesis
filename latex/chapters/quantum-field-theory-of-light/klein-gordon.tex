...
\begin{definition}[Normal-ordered product]
	The normal-ordered product of annihilation and creation operators puts all creation operators to the left and all annihilation operators to the right, for example,
	\begin{equation}
		N\left(
			\hat{a}^\dagger
			\hat{a}
