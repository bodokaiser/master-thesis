...
\end{lemma}
\begin{theorem}[Tensor Maxwell equations]\label{thm:covariant_maxwell_equations}
	...
	\end{align}
\end{theorem}
\begin{theorem}[Vector Maxwell equations]\label{thm:non_covarain_maxwell_equations}
