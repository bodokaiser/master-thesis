...
\end{theorem}
For the proof see \proofref{the appendix}{thm:mw_local_gauge_invariance}.

The unphysical degrees of freedom in the Maxwell field can be removed by imposing a gauge condition.
...
\end{lemma}
For the proof see \proofref{the appendix}{thm:mw_field_strength_antisymmetry}.
\begin{theorem}[Covariant Maxwell equations]\label{thm:covariant_maxwell_equations}
...
\end{theorem}
The proof is given in \proofref{the appendix}{thm:covariant_maxwell_equations}.
\begin{theorem}[Non-covariant Maxwell equations]\label{thm:non_covarain_maxwell_equations}
	...
	\end{align}
\end{theorem}
For the proof see \proofref{the appendix}{thm:non_covarain_maxwell_equations}.
