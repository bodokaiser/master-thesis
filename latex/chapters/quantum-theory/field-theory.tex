...
\begin{align}
	...
	.
\end{align}
The Hamiltonian and momentum operator~\cite[p.~199]{Greiner2013}
\begin{align}
	\hat{H}
	&=
	\sum_{\lambda=1,2}
	...
	\hat{a}_\lambda^\dagger(\vb{p})
	\hat{a}_\lambda(\vb{p})
	\label{eq:maxwell_hamiltonian_operator}
	\\
	\vu{P}
	&=
	\sum_{\lambda=1,2}
...
\end{align}
can be found by inserting the Maxwell operator into their classical definitions from the energy-momentum tensor and applying normal ordering.\footnote{Normal ordering removes infinite terms, e.g., the "vacuum energy", for us.}