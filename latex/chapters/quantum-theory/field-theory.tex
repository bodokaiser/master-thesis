...
\subsection{Lorentz force law, field-strength tensor and electromagnetic field components}
...
\begin{equation}
	\hat{a}_\lambda^\dagger(\vb{p})
	\hat{a}_\lambda(\vb{p})
	\label{eq:maxwell_number_density}
	,
\end{equation}
...
\Cref{eq:maxwell_number_density} suggests the total particle number operator to be
\begin{equation}
	\hat{N}
	=
	\int\frac{\dd[3]{p}}{(2\pi)^3}
...
\begin{align}
	...
	.
\end{align}
In the next section, we provide a more rigorous discussion of the particle aspects.