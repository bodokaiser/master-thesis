...
\begin{equation}
	...
	.
\end{equation}
\Cref{eq:maxwell_expansion} 

% discussion of result (classical, outlook to quantization, Fourier amplitudes correspond to modes - cite paper, ...)

% we can already "guess" the quantization when thinking about the "classical limit" of a coherent state


\subsection{Canonical quantization in the Coulomb gauge}

% this makes more sense to discuss in the quantum setting when we introduced the annihilation operator
