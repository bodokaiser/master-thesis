...
\begin{equation}
	...
	E_i(\vb{p})
	+
	\int\frac{\odif[order={3}]{q}}{(2\pi)^3}
...
\begin{equation}
	...
	=	
	\frac{1}{2}
	\int\frac{\odif[order={3}]{p}}{(2\pi)^3}
	\int\frac{\odif[order={3}]{q}}{(2\pi)^3}
	\chi_{ijk}^{(2)}(\vb{q},\vb{p})
	E^i(\vb{p})
	E^j(\vb{p})
...
\begin{equation}
	...
	=
	\frac{1}{2}
	\int\frac{\odif{p}}{2\pi}
	\int\frac{\odif{q}}{2\pi}
	\Upsilon(p,q)
	\hat{a}_x(q)
	\hat{a}_z^\dagger(p-q)
	\hat{a}_z(p+q)
