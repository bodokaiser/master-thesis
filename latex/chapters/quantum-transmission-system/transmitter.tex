...
We apply the unitary operator for the \gls{mzm}, \cref{eq:mzm_operator}, and apply it to a coherent and vacuum input state
\begin{equation}
	\begin{split}
		\hat{U}_\text{MZM}
		\ket{\alpha,0}
...
Under a unitary transformation, the displacement operator becomes
\begin{equation}
	\begin{split}
		\hat{U}
		\hat{D}(\alpha)
