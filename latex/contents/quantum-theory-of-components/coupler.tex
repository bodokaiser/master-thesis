...
An optical two-port is a passive component with two optical in- and outputs, generally assumed to be \gls{lti}.\footnote{The optical splitter is a special case of the optical coupler where one of the two optical inputs is zero, or, more precisely, the vacuum state.}
Two particular optical two-ports, optical couplers and splitters, appear in almost every optical setup or are building blocks of more complex components, making a thorough analysis advisable.

In the following, we would like to illuminate the versatile aspects of the optical two-port.
