...
\end{figure}
The output voltage-signal $y(t)$ in \Cref{fig:components_detector_direct} is equal to the photon flux $\abs{\alpha(t)}^2$ convolved with the combined response of the detector and the \gls{tia} $\eta$, i.e.,
\begin{equation}
	y(t)
	=
