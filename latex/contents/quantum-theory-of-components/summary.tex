...
For the ideal optical two-port being a lossless \gls{lti} system, we found most intuitive a characterization in terms of a unitary scattering matrix including reflection and transmission coefficients~\cite{Vogel2006}.
...
\end{figure}
The voltage output signal $y(t)$ in \Cref{fig:components_detector_direct} is equal to the photon flux $\abs{\alpha(t)}^2$ convolved with the combined response of the detector and the \gls{tia} $\eta$, i.e.,
\begin{equation}
	y(t)
	=
...
\end{figure}
The voltage output signal $z(t)$ in \Cref{fig:components_detector_balanced} is equal to the projection of the down-converted complex signal $\alpha(t)$ onto a real axis under the \gls{lo} angle $\vartheta$, i.e.,
\begin{equation}
	z(t)
	=
	2\Re
