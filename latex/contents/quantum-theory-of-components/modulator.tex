...
The (electro-optical) modulators allow us to encode an electrical signal onto an optical carrier.
In that sense, they are the interface between the electrical and optical domains.
Strictly speaking, the crossover occurs at the electro-optical phase modulator as other modulators follow from an optical arrangement of phase modulators.
...
\begin{figure}[htb]
    ...
    \caption{Pockels cell of length $l$ and diameter $d$: The quantum mode of an optical field, $\hat{E}_1(\omega)$, enters the Pockels cell from the left. Inside the Pockels cell, a quantum mode of an electric field, $\hat{E}_2(\omega^\prime)$, couples with the optical field and produces an outgoing quantum mode of an optical field, $\hat{E}_1^\prime(\omega+\omega^\prime)$.}\label{fig:pockels_cell}
\end{figure}
\Cref{fig:pockels_cell} depicts a Pockels modulator comprising a Pockels cell embedded into a dielectric waveguide.
