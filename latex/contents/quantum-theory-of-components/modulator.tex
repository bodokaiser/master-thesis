...
The refractive index tensor of an ideal Pockels medium can be approximated\footnote{See, for instance, Ref.~\cite{Murti2014} and Ref.~\cite[p.~1070]{Mandel1995}.}
\begin{equation}
	...
	\chi_{ij}^{(1)}(\omega)
	+
	\int\frac{\dd{\omega^\prime}}{(2\pi)^3}
	\chi_{ijk}^{(2)}(\omega^\prime,\omega)
	E^j(\omega^\prime)
	E^k(\omega-\omega^\prime)
\end{equation}
wherein $\chi^{(n)}$ the denotes the $n$th order of the electric susceptibility tensor.
