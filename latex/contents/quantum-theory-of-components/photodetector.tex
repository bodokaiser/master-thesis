...
Contrary, a photodiode is typically made of a PN-junction (\Cref{fig:photodiode}), a junction of a positively- (P) with a negatively-doped (N) semiconductor, supplemented by a contact on the P- and a contact on the N-doped semiconductor.
...
In \Cref{app:photodetection_theory} we extend the photoelectron model to derive the differential probability for photoelectron emission.
