...
\begin{figure}[htb]
	\centering
	\includegraphics{figures/circuitikz/upconversion}
...
Indeed, if we identify the mixers in the upconversion diagram, \Cref{fig:upconversion_block}, with \gls{mzm}s, we find ourselves with the electro-optical \gls{iqm} for which we derived a coherent state transform, \cref{eq:iqm_modulation}.
