...
Let $\ket{1_f}$ be a smeared particle state, then the single-particle wave function providing the probability amplitude density of finding the particle at $(t,\vb{x})$~\cite[p.~24]{Peskin1995} equals
\begin{equation}
	\Psi(t,\vb{x})
	=
	\vacbra
