...
The interaction Hamiltonian for a general three-wave mixing process is\footnote{The interaction Hamiltonian is time-independent as the total field energy is conserved.}
\begin{equation}
	\hat{H}_\text{int}
	=
	\int\dd[3]{x}
